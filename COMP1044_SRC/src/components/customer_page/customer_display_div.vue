...
<template>
    <div v-if="is_login">
        <!-- title -->
        <div class="flex justify-center items-center py-2 font-bold text-2xl border-pink-700 border-b-4 bg-pink-500"><span class="py-1 px-6 bg-pink-300 rounded-full">Customer</span></div>
        <div class="flex min-w-max max-w-screen min-h-min h-screen max-h-screen bg-gradient-to-r bg-linear-to-bl from-violet-500 to-fuchsia-500 overflow-auto justify-center">
            ...
            <div class="flex flex-col min-h-max max-h-max w-180 max-w-180 min-w-180 m-2">
                ...
                <div class="bg-pink-300 rounded-md border-pink-700 border-3 m-1 h-20 flex justify-end">
                    <router-link class="mx-3 my-4 bg-green-500 py-2 px-4 rounded-full font-bold hover:bg-green-800 hover:text-white" :to="{name: 'individual_creation_page'}" tag="button">Create new individual</router-link>
                </div>
