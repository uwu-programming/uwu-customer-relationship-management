...
function retrieve_email_address($conn){
    try {
        ...
        if (array_key_exists("email_address", (array)$post_data)){
            $sql_query = "SELECT * FROM individual WHERE email_address = '$post_data->email_address'";
